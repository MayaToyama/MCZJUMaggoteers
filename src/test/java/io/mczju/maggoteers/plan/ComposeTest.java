...
class ComposeTest {
    ...
    void multipleAffixesMultiply() {
        Affix armored = new Affix("armored", 2.0, 1, 1, 1, List.of(), "x");
        Affix berserk = new Affix("berserk", 1, 1.5, 1.2, 1, List.of(), "x");
    ...
    void dropScalesWithGreedy() {
        Affix greedy = new Affix("greedy", 1, 1, 1, 1.5, List.of(), "x");
